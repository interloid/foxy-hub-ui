...
$function$;
ALTER TABLE public.clients ADD COLUMN portal boolean DEFAULT true NOT NULL;
ALTER TABLE public.invitations ADD COLUMN job_title text;
...
ALTER TABLE public.memberships ADD COLUMN job_title text;
